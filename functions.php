...
em{float:left; width:45%; margin-left:15px; font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 22px; color: #666666; text-decoration: none; }
.submit { padding:10px;}
.bbt {width:100%; height:30px; font-size: 12px; line-height: 30px; color: #0066CC; float:left; padding-left:10px; text-decoration: none; }
						...
						<table class="form-table">
							<tr>
								<td>
									...
									<em>网站关键词（Meta Keywords），中间用半角逗号隔开。如：WordPress,独立博客</em>
								</td>
							</tr>
							<tr>
								<td>
									...
									<em>网站描述（Meta Description），针对搜索引擎设置的网页描述。
									<br />
									如： 这儿是某某设计公司官方网站</em> 
								</td>
							</tr>
						...
						<table class="form-table">
							...
							<tr>
								<td>
									...
									<em>
										输入网站底部logo图片地址。（图片高不超过63px,） 如：http://localhost/wordpress/logo.jpg
									</em>
								</td>
							</tr>
						</table>
						...
						<table class="form-table">
							<tr>
								<td>
									...
									<em>
										输入图片地址。（图片大小宽972px， 高390px,） 如：http://localhost/wordpress/tupian.jpg
									</em>
